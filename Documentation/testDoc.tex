...
\begin{document}
	...
	sievenna's Huffman coding has been tested on the Large Text Compression Benchmark \cite{mahoney2011large} as well as the Calgary corpus \cite{bell1989modeling}.
	
	Image compression benchmark from \href{http://imagecompression.info/test_images/}{imagecompression.info} \cite{imagecompressionbenchmark}.
	
	An uncompressed 8-bit RGB image called nightshot\_iso\_100.ppm was compressed from 22.128 MB to 17.843427 MB giving a size reduction of 19.36\%.
	
	The first 100 MB of the Large Text Compression Benchmark compressed down to 63.862 MB, giving a size reduction of 36.14\%.
	
%	\begin{table}
%		\begin{tabular}{llllll}
%			\toprule
%			File & Size & Compressed & Ratio & Compression Time & Decompression Time \\
%			\midrule
%			nightshot\_iso\_100 & 22.128 MB & 17.843427 MB & 1.240
%			\bottomrule
%		\end{tabular}
%	\end{table}
