...
\begin{document}
	...
	It will use Huffman coding \cite{mahoney2012data, sedgewick2011algorithms} to achieve this.
	...
	sievenna will compress most files to 70\% or less of their original size.
